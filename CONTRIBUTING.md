...
- User-visible strings and per-language typesetting live in `publish/i18n.ts`; adding a language means adding one `Messages` object there and one code to `model/language.ts`.
